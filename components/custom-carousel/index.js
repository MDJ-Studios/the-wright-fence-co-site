...
import s from "./customCarousel.module.css";

export default function CustomCarousel({ slides, simpleMode, heading, subheading, ctaText, ctaLink }) {
                    ...
                    {index === current && (
                        <>
                            ...
                            <div className={s.caption}>
                                <h2>{heading}</h2>
                                <p>{subheading}</p>
                                <button className={s.ctaButton} onClick={() => handleScroll(ctaLink)}>
                                    {ctaText}
                                </button>
                            </div>
                        </>
